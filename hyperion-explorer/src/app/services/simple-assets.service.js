...
exports.SimpleAssetsService = void 0;
var core_1 = require("@angular/core");
var environment_1 = require("../../environments/environment");
var SimpleAssetsService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.httpClient.get(this.getNftHistoryUrl + assetId).toPromise()];
                    case 2:
                        data = _a.sent();
                        this.loaded = true;
    ...
    SimpleAssetsService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        })
    ], SimpleAssetsService);
