...
var LaunchDarklyService = /** @class */ (function () {
    ...
    LaunchDarklyService_1 = LaunchDarklyService;
    LaunchDarklyService.prototype.initLaunchDarkly = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, LaunchDarklyService_1.client.waitForInitialization()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    LaunchDarklyService.prototype.variation = function (flag) {
        return __awaiter(this, void 0, void 0, function () {
            var defaultValue;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        defaultValue = featureFlags_1.featureFlags[flag].defaultValue;
                        return [4 /*yield*/, LaunchDarklyService_1.client.waitUntilReady()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, LaunchDarklyService_1.client.variation("".concat(flag), defaultValue)];
                }
            });
        });
    };
