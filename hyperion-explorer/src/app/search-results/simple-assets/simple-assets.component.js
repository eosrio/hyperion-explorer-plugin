...
exports.SimpleAssetsComponent = void 0;
...
var SimpleAssetsComponent = /** @class */ (function () {
    function SimpleAssetsComponent(activatedRoute, simpleAssetsService, chainData, title) {
    ...
    SimpleAssetsComponent.prototype.objectKeyCount = function (obj) {
        try {
    ...
    SimpleAssetsComponent.prototype.ngOnInit = function () {
        var _this = this;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.simpleAssetsService.getHistoryByAssetId(routeParams.asset_id)];
                    case 1:
                        _a.tx = _b.sent();
                        if (!this.chainData.chainInfoData.chain_name) {
                            this.title.setTitle("Asset ".concat(routeParams.asset_id, " \u2022 Hyperion Explorer"));
                        }
                        else {
                            this.title.setTitle("Asset ".concat(routeParams.asset_id, " \u2022 ").concat(this.chainData.chainInfoData.chain_name, " Hyperion Explorer"));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    SimpleAssetsComponent.prototype.formatDate = function (date) {
